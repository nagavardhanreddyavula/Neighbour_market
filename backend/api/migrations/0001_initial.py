# Generated by Django 6.0.8 on 2026-08-05 01:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField(blank=True, default='Bangalore, Karnataka, India', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='in_carts', to='api.product')),
            ],
            options={
                'unique_together': {('user', 'product')},
            },
